...
#ifndef EXTI_INC_MCAL_EXTI_H_
#define EXTI_INC_MCAL_EXTI_H_
...
typedef struct{
	...
	uint16_t		 GPIO_PIN;
	uint8_t			 IVT_IRQ_Number;    		//@ref IVT
...
typedef struct{
	...
	EXTI_GPIO_Mapping_t			EXTI_PIN;   	//@ref EXTI_define

	uint8_t						Trigger_Case;   //@ref EXTI_Trigger_define

	uint8_t						ISR_EN;   		//Enable Interrupt mask register & Enable NVIC  @ref EXTI_ISR_define
